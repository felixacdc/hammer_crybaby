...
<head>
    ...
    <![endif]-->
    <link rel="stylesheet" href="{{ asset('assets/images/ico/favicon.ico') }}">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ asset('assets/images/ico/apple-touch-icon-144-precomposed.png') }}">
    <link rel="apple-touch-icon-precomposed" sizes="144x144" href="{{ asset('assets/images/ico/apple-touch-icon-114-precomposed.png') }}">
...
<body id="home" class="homepage">
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse navbar-right">
                    <ul class="nav navbar-nav">
                        ...
                        <li class="scroll"><a href="#services">Noticias</a></li>
                        <li class="scroll"><a href="#portfolio">Tiendas</a></li>
    ...
    {!!Html::script('assets/js/jquery/jquery.inview.min.js')!!}

    {!!Html::script('assets/js/jquery/wow.min.js')!!}
    {!!Html::script('assets/js/jquery/jquery.js')!!}
</body>
</html>